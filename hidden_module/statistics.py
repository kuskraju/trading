...
def precision_maker(class_num):
    return lambda classification, targets: precision(classification, targets, class_num)


def recall_maker(class_num):
    return lambda classification, targets: recall(classification, targets, class_num)


def light_precision_maker(class_num):
    return lambda classification, targets: light_precision(classification, targets, class_num)


def light_accuracy(classification, targets):
...
def all_played(_, targets):
    targets = numpy.asarray(targets)
    return len(targets)


def earn_to_lose_ratio(classification, targets):
    targets = numpy.asarray(targets)
